    ...
    X_expected = pd.DataFrame(
        {
            ...
            "D": [22.0, 38.0, 26.0, 35.0, 35.0, 31.2],
            "F": [3, 1, 2, 1, 2, 3],
            "A__bin": ["0.0", "3.0", "0.0", "3.0", "1.0", "2.0"],
            "B__bin": ["2.0", "2.0", "0.0", "2.0", "0.0", "0.0"],
            "D__bin": ["0.0", "3.0", "0.0", "2.0", "2.0", "1.0"],
...
def data_inplace():
    ...
    X_expected = pd.DataFrame(
        {
            "A": ["0.0", "3.0", "0.0", "3.0", "1.0", "2.0"],
            "B": ["2.0", "2.0", "0.0", "2.0", "0.0", "0.0"],
            "C": ["a", "b", "c", "d", "e", "f"],
            "D": ["0.0", "3.0", "0.0", "2.0", "2.0", "1.0"],
