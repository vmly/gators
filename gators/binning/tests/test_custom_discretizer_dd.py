    ...
    X_expected = pd.DataFrame(
        {
            ...
            "D": [22.0, 38.0, 26.0, 35.0, 35.0, 31.2],
            "F": [3, 1, 2, 1, 2, 3],
            "A__bin": ["0.0", "2.0", "0.0", "2.0", "1.0", "1.0"],
            "D__bin": ["0.0", "1.0", "0.0", "1.0", "1.0", "1.0"],
            "F__bin": ["1.0", "0.0", "1.0", "0.0", "1.0", "1.0"],
        }
    )
    bins = {
    ...
    X_expected = pd.DataFrame(
        {
            ...
            "D": [22, 38, 26, 35, 35, 31],
            "F": [3, 1, 2, 1, 2, 3],
            "A__bin": ["0.0", "2.0", "0.0", "2.0", "0.0", "0.0"],
            "D__bin": ["0.0", "1.0", "0.0", "1.0", "1.0", "1.0"],
            "F__bin": ["1.0", "0.0", "1.0", "0.0", "1.0", "1.0"],
        }
    )
...
def data_inplace():
    ...
    X_expected = pd.DataFrame(
        {
            "A": ["0.0", "2.0", "0.0", "2.0", "1.0", "1.0"],
            "B": [1, 1, 0, 1, 0, 0],
            "C": ["a", "b", "c", "d", "e", "f"],
            "D": ["0.0", "1.0", "0.0", "1.0", "1.0", "1.0"],
            "F": ["1.0", "0.0", "1.0", "0.0", "1.0", "1.0"],
        }
    )
    bins = {
        "A": [-np.inf, 8.0, 40.0, np.inf],
