...
def data():
    ...
    np.random.seed(1)
    y = pd.Series(np.random.randint(0, n_classes, n_rows), name="TARGET"), npartitions=1)
    ...
    y_expected = pd.Series({2: 0, 28: 1, 13: 3, 10: 0, 26: 2], name="TARGET"), npartitions=1)
...
def data_ks():
    ...
    np.random.seed(1)
    y = ks.Series(np.random.randint(0, n_classes, n_rows), name="TARGET"), npartitions=1)
    obj = UnsupervisedSampling(n_samples=n_samples)
    X_expected = pd.DataFrame(
        {
            "A": [ 0, 7: 35, 8: 40, 18: 90, 21: 105, 20: 100],
            "B": [ 1, 7: 36, 8: 41, 18: 91, 21: 106, 20: 101],
            "C": [ 2, 7: 37, 8: 42, 18: 92, 21: 107, 20: 102],
            "D": [ 3, 7: 38, 8: 43, 18: 93, 21: 108, 20: 103],
            "E": [ 4, 7: 39, 8: 44, 18: 94, 21: 109, 20: 104],
        })
    y_expected = pd.Series([ 1, 7: 1, 8: 3, 18: 2, 21: 1, 20: 2], name="TARGET"), npartitions=1)
    return obj, X, y, X_expected, y_expected
